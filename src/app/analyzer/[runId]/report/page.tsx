      ...
      {mainPage && (
        <div className="my-8">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              <tr className="border-b">
                <td className="py-2">Content Structure</td>
                <td className="text-right font-mono">{Math.round(mainPage.content_score)}</td>
              </tr>
              <tr className="border-b">
                <td className="py-2">Schema Markup</td>
                <td className="text-right font-mono">{Math.round(mainPage.schema_score)}</td>
              </tr>
              <tr className="border-b">
                <td className="py-2">E-E-A-T Signals</td>
                <td className="text-right font-mono">{Math.round(mainPage.eeat_score)}</td>
              </tr>
              <tr className="border-b">
                <td className="py-2">Technical GEO</td>
                <td className="text-right font-mono">{Math.round(mainPage.technical_score)}</td>
              </tr>
              <tr className="border-b">
                <td className="py-2">Entity Authority</td>
                <td className="text-right font-mono">{Math.round(mainPage.entity_score)}</td>
              </tr>
              <tr className="border-b">
                <td className="py-2">AI Visibility</td>
                <td className="text-right font-mono">{Math.round(mainPage.ai_visibility_score)}</td>
              </tr>
            </tbody>
          </table>
        </div>
