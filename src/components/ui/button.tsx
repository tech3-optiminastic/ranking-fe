...
/** Brand primary CTA (orange), only applied via `variant="default"` so outline/ghost/etc. stay neutral. */
const DEFAULT_CTA_CLASS = "auth-cta-btn font-semibold text-white shadow-sm hover:text-white";
