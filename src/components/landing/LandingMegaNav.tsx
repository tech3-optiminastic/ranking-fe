  ...
  solutions: {
    ...
    items: [
      ...
      },
      {
        ...
        title: "Visibility",
        desc: "Track AI mentions, citations, and brand presence across every major engine.",
        icon: BarChart3,
      },
      {
        href: "/solutions/fix-playbook",
        title: "Fix Playbook",
        desc: "Prioritized GEO recommendations your team can ship this week.",
        icon: Target,
      },
      {
        href: "/solutions/competitive-lens",
        title: "Competitive Lens",
        desc: "Benchmark citation share and recommendation rate against rivals.",
        icon: LineChart,
      },
    ],
  },
