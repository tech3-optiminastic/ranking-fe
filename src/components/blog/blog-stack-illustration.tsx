    ...
    <div className="relative h-full w-full max-w-xl">
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative h-[340px] w-full sm:h-[380px]">
          ...
          <div className="absolute left-0 top-0 h-[300px] w-[94%] -rotate-[3deg] rounded-2xl border border-[#b45309]/20 bg-gradient-to-br from-amber-50 via-white to-amber-100/40 shadow-[0_20px_60px_-18px_rgba(180,83,9,0.32)]">
            <div className="p-5">
              ...
              <p className="mt-2 text-[11.5px] leading-relaxed text-neutral-600">
                Read the citation roll-up. Pick the rival URLs worth beating. Ship the page that
                wins the citation back.
              </p>
